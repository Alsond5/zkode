...
export const themeSettings: IStandaloneThemeData = {
    "base": "vs-dark",
    "inherit": false,
    "colors": {
    ...
    "rules": [
        ...
        {
            "token": "entity.name.type.module.js,entity.name.type.module.ts,entity.name.type.module.jsx,entity.name.type.module.tsx",
            "foreground": "#98C379"
        },
        {
